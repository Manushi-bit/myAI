...
export const CHAT_HEADER: string = `HimalAI: The Virtual Sherpa`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `© 2025 Sherpa Adventure Gear`;
export const CLEAR_BUTTON_TEXT: string = `Clear Conversation`;
export const PAGE_TITLE: string = `HimalAI: The Virtual Sherpa`;
